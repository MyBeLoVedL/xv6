...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	36650513          	addi	a0,a0,870 # 1400 <l_free+0x10>
      a2:	00001097          	auipc	ra,0x1
      a6:	e1c080e7          	jalr	-484(ra) # ebe <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	35650513          	addi	a0,a0,854 # 1400 <l_free+0x10>
      b2:	00001097          	auipc	ra,0x1
      b6:	e14080e7          	jalr	-492(ra) # ec6 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	34c50513          	addi	a0,a0,844 # 1408 <l_free+0x18>
  ...
  chdir("/");
      ...
      da:	35250513          	addi	a0,a0,850 # 1428 <l_free+0x38>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	35298993          	addi	s3,s3,850 # 1438 <l_free+0x48>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	34098993          	addi	s3,s3,832 # 1430 <l_free+0x40>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
      ...
      sbrk(6011);
      fc:	6a85                	lui	s5,0x1
      fe:	77ba8a93          	addi	s5,s5,1915 # 177b <buf.0+0x5b>
     102:	a825                	j	13a <go+0xc2>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     104:	20200593          	li	a1,514
     108:	00001517          	auipc	a0,0x1
     10c:	33850513          	addi	a0,a0,824 # 1440 <l_free+0x50>
    ...
    if(what == 1){
     ...
     292:	3d258593          	addi	a1,a1,978 # 1660 <l_free+0x270>
     ...
     2b6:	40650513          	addi	a0,a0,1030 # 16b8 <l_free+0x2c8>
     ...
     2d4:	18050513          	addi	a0,a0,384 # 1450 <l_free+0x60>
     ...
     35c:	11850513          	addi	a0,a0,280 # 1470 <l_free+0x80>
     ...
     37e:	10650513          	addi	a0,a0,262 # 1480 <l_free+0x90>
     ...
     396:	38e58593          	addi	a1,a1,910 # 1720 <buf.0>
     39a:	854a                	mv	a0,s2
     ...
     3ae:	37658593          	addi	a1,a1,886 # 1720 <buf.0>
     3b2:	854a                	mv	a0,s2
     ...
     4b4:	05050513          	addi	a0,a0,80 # 1500 <l_free+0x110>
     ...
     502:	00250513          	addi	a0,a0,2 # 1500 <l_free+0x110>
     ...
     55e:	fbe50513          	addi	a0,a0,-66 # 1518 <l_free+0x128>
     ...
     58a:	f5a50513          	addi	a0,a0,-166 # 14e0 <l_free+0xf0>
     ...
     5ac:	f5850513          	addi	a0,a0,-168 # 1500 <l_free+0x110>
     ...
     5c6:	f6650513          	addi	a0,a0,-154 # 1528 <l_free+0x138>
     ...
     614:	ef050513          	addi	a0,a0,-272 # 1500 <l_free+0x110>
     ...
     670:	ed450513          	addi	a0,a0,-300 # 1540 <l_free+0x150>
     ...
     69c:	ec058593          	addi	a1,a1,-320 # 1558 <l_free+0x168>
     ...
     79e:	d6650513          	addi	a0,a0,-666 # 1500 <l_free+0x110>
     ...
     7e4:	d7858593          	addi	a1,a1,-648 # 1558 <l_free+0x168>
     ...
     856:	d6e50513          	addi	a0,a0,-658 # 15c0 <l_free+0x1d0>
     ...
     870:	d6c50513          	addi	a0,a0,-660 # 15d8 <l_free+0x1e8>
     ...
     88c:	d6850513          	addi	a0,a0,-664 # 15f0 <l_free+0x200>
     ...
     8a6:	d7650513          	addi	a0,a0,-650 # 1618 <l_free+0x228>
     ...
     8c0:	c8458593          	addi	a1,a1,-892 # 1540 <l_free+0x150>
     8c4:	4509                	li	a0,2
     ...
     8dc:	c6858593          	addi	a1,a1,-920 # 1540 <l_free+0x150>
     8e0:	4509                	li	a0,2
     ...
     938:	d0c58593          	addi	a1,a1,-756 # 1640 <l_free+0x250>
     93c:	4509                	li	a0,2
     ...
     9ac:	b5858593          	addi	a1,a1,-1192 # 1500 <l_free+0x110>
     9b0:	4509                	li	a0,2
     ...
     9f8:	c4c58593          	addi	a1,a1,-948 # 1640 <l_free+0x250>
     9fc:	4509                	li	a0,2
     ...
     a3c:	c0858593          	addi	a1,a1,-1016 # 1640 <l_free+0x250>
     a40:	4509                	li	a0,2
     ...
     aa4:	a6058593          	addi	a1,a1,-1440 # 1500 <l_free+0x110>
     aa8:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     acc:	a1850513          	addi	a0,a0,-1512 # 14e0 <l_free+0xf0>
     ad0:	00000097          	auipc	ra,0x0
     ad4:	3d6080e7          	jalr	982(ra) # ea6 <unlink>
  unlink("b");
     ad8:	00001517          	auipc	a0,0x1
     adc:	9b850513          	addi	a0,a0,-1608 # 1490 <l_free+0xa0>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b10:	9f450513          	addi	a0,a0,-1548 # 1500 <l_free+0x110>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b52:	9b250513          	addi	a0,a0,-1614 # 1500 <l_free+0x110>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f3e:	7ae50513          	addi	a0,a0,1966 # 16e8 <digits>
     f42:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    100a:	6e2b8b93          	addi	s7,s7,1762 # 16e8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    114a:	59a90913          	addi	s2,s2,1434 # 16e0 <l_free+0x2f0>
        while(*s != 0){
...
void free(void *ap) {
  ...
  for (p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1212:	50a7b783          	ld	a5,1290(a5) # 1718 <freep>
...
void free(void *ap) {
  ...
  freep = p;
    ...
    1282:	48f73d23          	sd	a5,1178(a4) # 1718 <freep>
}
...
void *malloc(uint nbytes) {
  ...
  if ((prevp = freep) == 0) {
    ...
    12b4:	46853503          	ld	a0,1128(a0) # 1718 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12dc:	44090913          	addi	s2,s2,1088 # 1718 <freep>
  if (p == (char *)-1)
    12e0:	5afd                	li	s5,-1
    12e2:	a88d                	j	1354 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12e4:	00001797          	auipc	a5,0x1
    12e8:	82478793          	addi	a5,a5,-2012 # 1b08 <base>
    12ec:	00000717          	auipc	a4,0x0
    12f0:	42f73623          	sd	a5,1068(a4) # 1718 <freep>
    ...
    1316:	40a73323          	sd	a0,1030(a4) # 1718 <freep>
      return (void *)(p + 1);
...
void mem_init() {
  ...
  alloc.next_page = (page_t *)sbrk(PGSIZE);
    ...
    137e:	b64080e7          	jalr	-1180(ra) # ede <sbrk>
    1382:	00000797          	auipc	a5,0x0
    1386:	38a7b723          	sd	a0,910(a5) # 1710 <alloc>
  page_t *p = (page_t *)alloc.next_page;
  p->cur = (void *)p + sizeof(page_t);
    138a:	00850793          	addi	a5,a0,8 # 1008 <vprintf+0x46>
    138e:	e11c                	sd	a5,0(a0)
}
...
0000000000001398 <l_alloc>:

void *l_alloc(u32 size) {
    1398:	1101                	addi	sp,sp,-32
    139a:	ec06                	sd	ra,24(sp)
    139c:	e822                	sd	s0,16(sp)
    139e:	e426                	sd	s1,8(sp)
    13a0:	1000                	addi	s0,sp,32
    13a2:	84aa                	mv	s1,a0
  if (!if_init) {
    13a4:	00000797          	auipc	a5,0x0
    13a8:	3647a783          	lw	a5,868(a5) # 1708 <if_init>
    13ac:	c795                	beqz	a5,13d8 <l_alloc+0x40>
    mem_init();
    if_init = 1;
  }
  void *res = 0;
  u32 avail = PGSIZE - (alloc.next_page->cur - (void *)(alloc.next_page)) -
    13ae:	00000717          	auipc	a4,0x0
    13b2:	36273703          	ld	a4,866(a4) # 1710 <alloc>
    13b6:	6308                	ld	a0,0(a4)
    13b8:	40e506b3          	sub	a3,a0,a4
              sizeof(page_t);
  if (avail > size) {
    13bc:	6785                	lui	a5,0x1
    13be:	37e1                	addiw	a5,a5,-8
    13c0:	9f95                	subw	a5,a5,a3
    13c2:	02f4f563          	bgeu	s1,a5,13ec <l_alloc+0x54>
    res = alloc.next_page->cur;
    alloc.next_page->cur += size;
    13c6:	1482                	slli	s1,s1,0x20
    13c8:	9081                	srli	s1,s1,0x20
    13ca:	94aa                	add	s1,s1,a0
    13cc:	e304                	sd	s1,0(a4)
  } else {
    return 0;
  }
  return res;
    ...
    13d2:	64a2                	ld	s1,8(sp)
    13d4:	6105                	addi	sp,sp,32
    13d6:	8082                	ret
    mem_init();
    13d8:	00000097          	auipc	ra,0x0
    13dc:	f98080e7          	jalr	-104(ra) # 1370 <mem_init>
    if_init = 1;
    13e0:	4785                	li	a5,1
    13e2:	00000717          	auipc	a4,0x0
    13e6:	32f72323          	sw	a5,806(a4) # 1708 <if_init>
    13ea:	b7d1                	j	13ae <l_alloc+0x16>
    return 0;
    13ec:	4501                	li	a0,0
    13ee:	b7c5                	j	13ce <l_alloc+0x36>

00000000000013f0 <l_free>:

    13f0:	1141                	addi	sp,sp,-16
    13f2:	e422                	sd	s0,8(sp)
    13f4:	0800                	addi	s0,sp,16
    13f6:	6422                	ld	s0,8(sp)
