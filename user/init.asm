...
main(void)
{
  ...
  12:	90250513          	addi	a0,a0,-1790 # 910 <l_free+0x10>
  ...
  3a:	8e290913          	addi	s2,s2,-1822 # 918 <l_free+0x18>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8fe50513          	addi	a0,a0,-1794 # 968 <l_free+0x68>
  ...
  8c:	88850513          	addi	a0,a0,-1912 # 910 <l_free+0x10>
  90:	00000097          	auipc	ra,0x0
  94:	31e080e7          	jalr	798(ra) # 3ae <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	87650513          	addi	a0,a0,-1930 # 910 <l_free+0x10>
  a2:	00000097          	auipc	ra,0x0
  a6:	304080e7          	jalr	772(ra) # 3a6 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	88450513          	addi	a0,a0,-1916 # 930 <l_free+0x30>
  ...
  d2:	87a50513          	addi	a0,a0,-1926 # 948 <l_free+0x48>
  d6:	00000097          	auipc	ra,0x0
  da:	2c8080e7          	jalr	712(ra) # 39e <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	87250513          	addi	a0,a0,-1934 # 950 <l_free+0x50>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51a:	47ab8b93          	addi	s7,s7,1146 # 990 <digits>
 ...
 65a:	33290913          	addi	s2,s2,818 # 988 <l_free+0x88>
        while(*s != 0){
...
void free(void *ap) {
 ...
 722:	2aa7b783          	ld	a5,682(a5) # 9c8 <freep>
...
void free(void *ap) {
 ...
 792:	22f73d23          	sd	a5,570(a4) # 9c8 <freep>
}
 796:	6422                	ld	s0,8(sp)
...
void *malloc(uint nbytes) {
 ...
 7c4:	20853503          	ld	a0,520(a0) # 9c8 <freep>
 ...
 7ec:	1e090913          	addi	s2,s2,480 # 9c8 <freep>
  if (p == (char *)-1)
 7f0:	5afd                	li	s5,-1
 7f2:	a88d                	j	864 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7f4:	00000797          	auipc	a5,0x0
 7f8:	1dc78793          	addi	a5,a5,476 # 9d0 <base>
 7fc:	00000717          	auipc	a4,0x0
 800:	1cf73623          	sd	a5,460(a4) # 9c8 <freep>
 804:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 826:	1aa73323          	sd	a0,422(a4) # 9c8 <freep>
      return (void *)(p + 1);
...
void mem_init() {
 ...
 896:	12a7b723          	sd	a0,302(a5) # 9c0 <alloc>
  page_t *p = (page_t *)alloc.next_page;
  p->cur = (void *)p + sizeof(page_t);
 89a:	00850793          	addi	a5,a0,8 # 1008 <__BSS_END__+0x628>
 89e:	e11c                	sd	a5,0(a0)
}
 8a0:	60a2                	ld	ra,8(sp)
 8a2:	6402                	ld	s0,0(sp)
...
void *l_alloc(u32 size) {
 ...
 8b8:	1047a783          	lw	a5,260(a5) # 9b8 <if_init>
 8bc:	c795                	beqz	a5,8e8 <l_alloc+0x40>
    mem_init();
    if_init = 1;
  }
  void *res = 0;
 ...
 8c2:	10273703          	ld	a4,258(a4) # 9c0 <alloc>
 8c6:	6308                	ld	a0,0(a4)
 8c8:	40e506b3          	sub	a3,a0,a4
              sizeof(page_t);
  if (avail > size) {
 8cc:	6785                	lui	a5,0x1
 8ce:	37e1                	addiw	a5,a5,-8
 8d0:	9f95                	subw	a5,a5,a3
 8d2:	02f4f563          	bgeu	s1,a5,8fc <l_alloc+0x54>
    res = alloc.next_page->cur;
    alloc.next_page->cur += size;
 8d6:	1482                	slli	s1,s1,0x20
 ...
 8e2:	64a2                	ld	s1,8(sp)
 8e4:	6105                	addi	sp,sp,32
 8e6:	8082                	ret
    mem_init();
 8e8:	00000097          	auipc	ra,0x0
 8ec:	f98080e7          	jalr	-104(ra) # 880 <mem_init>
    if_init = 1;
 8f0:	4785                	li	a5,1
 8f2:	00000717          	auipc	a4,0x0
 8f6:	0cf72323          	sw	a5,198(a4) # 9b8 <if_init>
 8fa:	b7d1                	j	8be <l_alloc+0x16>
    return 0;
 8fc:	4501                	li	a0,0
 8fe:	b7c5                	j	8de <l_alloc+0x36>

0000000000000900 <l_free>:
