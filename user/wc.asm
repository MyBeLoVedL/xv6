...
wc(int fd, char *name)
{
  ...
  3c:	978a0a13          	addi	s4,s4,-1672 # 9b0 <l_free+0x12>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	91250513          	addi	a0,a0,-1774 # 9c8 <l_free+0x2a>
  ...
  e8:	8d450513          	addi	a0,a0,-1836 # 9b8 <l_free+0x1a>
...
main(int argc, char *argv[])
{
 ...
 162:	87a58593          	addi	a1,a1,-1926 # 9d8 <l_free+0x3a>
 166:	4501                	li	a0,0
 ...
 180:	86450513          	addi	a0,a0,-1948 # 9e0 <l_free+0x42>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ec:	51850513          	addi	a0,a0,1304 # a00 <digits>
 4f0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b8:	44cb8b93          	addi	s7,s7,1100 # a00 <digits>
 ...
 6f8:	30490913          	addi	s2,s2,772 # 9f8 <l_free+0x5a>
        while(*s != 0){
...
void free(void *ap) {
 ...
 7c0:	26c7b783          	ld	a5,620(a5) # a28 <freep>
...
void free(void *ap) {
 ...
 830:	1ef73e23          	sd	a5,508(a4) # a28 <freep>
}
 834:	6422                	ld	s0,8(sp)
...
void *malloc(uint nbytes) {
 ...
 862:	1ca53503          	ld	a0,458(a0) # a28 <freep>
 ...
 88a:	1a290913          	addi	s2,s2,418 # a28 <freep>
  if (p == (char *)-1)
 88e:	5afd                	li	s5,-1
 890:	a88d                	j	902 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 892:	00000797          	auipc	a5,0x0
 896:	39e78793          	addi	a5,a5,926 # c30 <base>
 89a:	00000717          	auipc	a4,0x0
 89e:	18f73723          	sd	a5,398(a4) # a28 <freep>
 8a2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8c4:	16a73423          	sd	a0,360(a4) # a28 <freep>
      return (void *)(p + 1);
...
void mem_init() {
 ...
 934:	0ea7b823          	sd	a0,240(a5) # a20 <alloc>
  page_t *p = (page_t *)alloc.next_page;
  p->cur = (void *)p + sizeof(page_t);
 938:	00850793          	addi	a5,a0,8 # 1008 <__BSS_END__+0x3c8>
 93c:	e11c                	sd	a5,0(a0)
}
 93e:	60a2                	ld	ra,8(sp)
 940:	6402                	ld	s0,0(sp)
...
void *l_alloc(u32 size) {
 ...
 956:	0c67a783          	lw	a5,198(a5) # a18 <if_init>
 95a:	c795                	beqz	a5,986 <l_alloc+0x40>
    mem_init();
    if_init = 1;
  }
  void *res = 0;
 ...
 960:	0c473703          	ld	a4,196(a4) # a20 <alloc>
 964:	6308                	ld	a0,0(a4)
 966:	40e506b3          	sub	a3,a0,a4
              sizeof(page_t);
  if (avail > size) {
 96a:	6785                	lui	a5,0x1
 96c:	37e1                	addiw	a5,a5,-8
 96e:	9f95                	subw	a5,a5,a3
 970:	02f4f563          	bgeu	s1,a5,99a <l_alloc+0x54>
    res = alloc.next_page->cur;
    alloc.next_page->cur += size;
 974:	1482                	slli	s1,s1,0x20
 976:	9081                	srli	s1,s1,0x20
 978:	94aa                	add	s1,s1,a0
 97a:	e304                	sd	s1,0(a4)
  } else {
    return 0;
  }
 ...
 98a:	f98080e7          	jalr	-104(ra) # 91e <mem_init>
    if_init = 1;
 98e:	4785                	li	a5,1
 990:	00000717          	auipc	a4,0x0
 994:	08f72423          	sw	a5,136(a4) # a18 <if_init>
 998:	b7d1                	j	95c <l_alloc+0x16>
    return 0;
 99a:	4501                	li	a0,0
 99c:	b7c5                	j	97c <l_alloc+0x36>

000000000000099e <l_free>:
