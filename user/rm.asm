...
main(int argc, char *argv[])
{
  ...
  42:	85258593          	addi	a1,a1,-1966 # 890 <l_free+0x10>
  46:	4509                	li	a0,2
  ...
  60:	84c58593          	addi	a1,a1,-1972 # 8a8 <l_free+0x28>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ce:	50650513          	addi	a0,a0,1286 # 8d0 <digits>
 3d2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49a:	43ab8b93          	addi	s7,s7,1082 # 8d0 <digits>
 ...
 5da:	2f290913          	addi	s2,s2,754 # 8c8 <l_free+0x48>
        while(*s != 0){
...
void free(void *ap) {
 ...
 6a2:	25a7b783          	ld	a5,602(a5) # 8f8 <freep>
...
void free(void *ap) {
 ...
 712:	1ef73523          	sd	a5,490(a4) # 8f8 <freep>
}
 716:	6422                	ld	s0,8(sp)
...
void *malloc(uint nbytes) {
 ...
 744:	1b853503          	ld	a0,440(a0) # 8f8 <freep>
 ...
 76c:	19090913          	addi	s2,s2,400 # 8f8 <freep>
  if (p == (char *)-1)
 770:	5afd                	li	s5,-1
 772:	a88d                	j	7e4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 774:	00000797          	auipc	a5,0x0
 778:	18c78793          	addi	a5,a5,396 # 900 <base>
 77c:	00000717          	auipc	a4,0x0
 780:	16f73e23          	sd	a5,380(a4) # 8f8 <freep>
 784:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a6:	14a73b23          	sd	a0,342(a4) # 8f8 <freep>
      return (void *)(p + 1);
...
void mem_init() {
 ...
 816:	0ca7bf23          	sd	a0,222(a5) # 8f0 <alloc>
  page_t *p = (page_t *)alloc.next_page;
  p->cur = (void *)p + sizeof(page_t);
 81a:	00850793          	addi	a5,a0,8 # 1008 <__BSS_END__+0x6f8>
 81e:	e11c                	sd	a5,0(a0)
}
 820:	60a2                	ld	ra,8(sp)
 822:	6402                	ld	s0,0(sp)
...
void *l_alloc(u32 size) {
 ...
 838:	0b47a783          	lw	a5,180(a5) # 8e8 <if_init>
 83c:	c795                	beqz	a5,868 <l_alloc+0x40>
    mem_init();
    if_init = 1;
  }
  void *res = 0;
 ...
 842:	0b273703          	ld	a4,178(a4) # 8f0 <alloc>
 846:	6308                	ld	a0,0(a4)
 848:	40e506b3          	sub	a3,a0,a4
              sizeof(page_t);
  if (avail > size) {
 84c:	6785                	lui	a5,0x1
 84e:	37e1                	addiw	a5,a5,-8
 850:	9f95                	subw	a5,a5,a3
 852:	02f4f563          	bgeu	s1,a5,87c <l_alloc+0x54>
    res = alloc.next_page->cur;
    alloc.next_page->cur += size;
 856:	1482                	slli	s1,s1,0x20
 858:	9081                	srli	s1,s1,0x20
 85a:	94aa                	add	s1,s1,a0
 85c:	e304                	sd	s1,0(a4)
  } else {
    return 0;
  }
 ...
 86c:	f98080e7          	jalr	-104(ra) # 800 <mem_init>
    if_init = 1;
 870:	4785                	li	a5,1
 872:	00000717          	auipc	a4,0x0
 876:	06f72b23          	sw	a5,118(a4) # 8e8 <if_init>
 87a:	b7d1                	j	83e <l_alloc+0x16>
    return 0;
 87c:	4501                	li	a0,0
 87e:	b7c5                	j	85e <l_alloc+0x36>

0000000000000880 <l_free>:
