...
int main(int argc, char **argv) {
  ...
  1e:	8a650513          	addi	a0,a0,-1882 # 8c0 <l_free+0x12>
  22:	00000097          	auipc	ra,0x0
  26:	66a080e7          	jalr	1642(ra) # 68c <printf>
    exit(0);
  2a:	4501                	li	a0,0
  ...
  3c:	8a850513          	addi	a0,a0,-1880 # 8e0 <l_free+0x32>
  40:	00000097          	auipc	ra,0x0
  44:	64c080e7          	jalr	1612(ra) # 68c <printf>
  for_(1000) {
  48:	4901                	li	s2,0
  ...
  50:	8a4a8a93          	addi	s5,s5,-1884 # 8f0 <l_free+0x42>
  for_(1000) {
  54:	3e800a13          	li	s4,1000
    p = l_alloc(sizeof(argv[1]) + 1);
  58:	4525                	li	a0,9
  5a:	00000097          	auipc	ra,0x0
  5e:	7fc080e7          	jalr	2044(ra) # 856 <l_alloc>
  62:	84aa                	mv	s1,a0
    if (!p)
  ...
  88:	608080e7          	jalr	1544(ra) # 68c <printf>
  for_(1000) {
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fc:	51050513          	addi	a0,a0,1296 # 908 <digits>
 400:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c8:	444b8b93          	addi	s7,s7,1092 # 908 <digits>
 ...
 608:	2fc90913          	addi	s2,s2,764 # 900 <l_free+0x52>
        while(*s != 0){
...
void free(void *ap) {
 ...
 6d0:	2647b783          	ld	a5,612(a5) # 930 <freep>
...
void free(void *ap) {
 ...
 740:	1ef73a23          	sd	a5,500(a4) # 930 <freep>
}
 744:	6422                	ld	s0,8(sp)
...
void *malloc(uint nbytes) {
 ...
 772:	1c253503          	ld	a0,450(a0) # 930 <freep>
 ...
 79a:	19a90913          	addi	s2,s2,410 # 930 <freep>
  if (p == (char *)-1)
 79e:	5afd                	li	s5,-1
 7a0:	a88d                	j	812 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7a2:	00000797          	auipc	a5,0x0
 7a6:	19678793          	addi	a5,a5,406 # 938 <base>
 7aa:	00000717          	auipc	a4,0x0
 7ae:	18f73323          	sd	a5,390(a4) # 930 <freep>
 7b2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d4:	16a73023          	sd	a0,352(a4) # 930 <freep>
      return (void *)(p + 1);
...
void mem_init() {
 ...
 83c:	b64080e7          	jalr	-1180(ra) # 39c <sbrk>
 840:	00000797          	auipc	a5,0x0
 844:	0ea7b423          	sd	a0,232(a5) # 928 <alloc>
  page_t *p = (page_t *)alloc.next_page;
  p->cur = (void *)p + sizeof(page_t);
 848:	00850793          	addi	a5,a0,8 # 1008 <__BSS_END__+0x6c0>
 84c:	e11c                	sd	a5,0(a0)
}
 84e:	60a2                	ld	ra,8(sp)
 850:	6402                	ld	s0,0(sp)
...
0000000000000856 <l_alloc>:

void *l_alloc(u32 size) {
 856:	1101                	addi	sp,sp,-32
 ...
 866:	0be7a783          	lw	a5,190(a5) # 920 <if_init>
 86a:	c795                	beqz	a5,896 <l_alloc+0x40>
    mem_init();
    if_init = 1;
  }
  void *res = 0;
 ...
 870:	0bc73703          	ld	a4,188(a4) # 928 <alloc>
 874:	6308                	ld	a0,0(a4)
 876:	40e506b3          	sub	a3,a0,a4
              sizeof(page_t);
  if (avail > size) {
 87a:	6785                	lui	a5,0x1
 87c:	37e1                	addiw	a5,a5,-8
 87e:	9f95                	subw	a5,a5,a3
 880:	02f4f563          	bgeu	s1,a5,8aa <l_alloc+0x54>
    res = alloc.next_page->cur;
    alloc.next_page->cur += size;
 884:	1482                	slli	s1,s1,0x20
 886:	9081                	srli	s1,s1,0x20
 888:	94aa                	add	s1,s1,a0
 88a:	e304                	sd	s1,0(a4)
  } else {
    return 0;
  }
 ...
 89a:	f98080e7          	jalr	-104(ra) # 82e <mem_init>
    if_init = 1;
 89e:	4785                	li	a5,1
 8a0:	00000717          	auipc	a4,0x0
 8a4:	08f72023          	sw	a5,128(a4) # 920 <if_init>
 8a8:	b7d1                	j	86c <l_alloc+0x16>
    return 0;
 8aa:	4501                	li	a0,0
 8ac:	b7c5                	j	88c <l_alloc+0x36>

00000000000008ae <l_free>:
