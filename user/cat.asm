...
cat(int fd)
{
  ...
  44:	8f858593          	addi	a1,a1,-1800 # 938 <l_free+0x12>
  48:	4509                	li	a0,2
  ...
  72:	8e258593          	addi	a1,a1,-1822 # 950 <l_free+0x2a>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	86658593          	addi	a1,a1,-1946 # 968 <l_free+0x42>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 474:	51850513          	addi	a0,a0,1304 # 988 <digits>
 478:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 540:	44cb8b93          	addi	s7,s7,1100 # 988 <digits>
 ...
 680:	30490913          	addi	s2,s2,772 # 980 <l_free+0x5a>
        while(*s != 0){
...
void free(void *ap) {
 ...
 748:	26c7b783          	ld	a5,620(a5) # 9b0 <freep>
...
void free(void *ap) {
 ...
 7b8:	1ef73e23          	sd	a5,508(a4) # 9b0 <freep>
}
 7bc:	6422                	ld	s0,8(sp)
...
void *malloc(uint nbytes) {
 ...
 7ea:	1ca53503          	ld	a0,458(a0) # 9b0 <freep>
 ...
 812:	1a290913          	addi	s2,s2,418 # 9b0 <freep>
  if (p == (char *)-1)
 816:	5afd                	li	s5,-1
 818:	a88d                	j	88a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 81a:	00000797          	auipc	a5,0x0
 81e:	39e78793          	addi	a5,a5,926 # bb8 <base>
 822:	00000717          	auipc	a4,0x0
 826:	18f73723          	sd	a5,398(a4) # 9b0 <freep>
 82a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 84c:	16a73423          	sd	a0,360(a4) # 9b0 <freep>
      return (void *)(p + 1);
...
void mem_init() {
 ...
 8bc:	0ea7b823          	sd	a0,240(a5) # 9a8 <alloc>
  page_t *p = (page_t *)alloc.next_page;
  p->cur = (void *)p + sizeof(page_t);
 8c0:	00850793          	addi	a5,a0,8 # 1008 <__BSS_END__+0x440>
 8c4:	e11c                	sd	a5,0(a0)
}
 8c6:	60a2                	ld	ra,8(sp)
 8c8:	6402                	ld	s0,0(sp)
...
void *l_alloc(u32 size) {
 ...
 8de:	0c67a783          	lw	a5,198(a5) # 9a0 <if_init>
 8e2:	c795                	beqz	a5,90e <l_alloc+0x40>
    mem_init();
    if_init = 1;
  }
  void *res = 0;
 ...
 8e8:	0c473703          	ld	a4,196(a4) # 9a8 <alloc>
 8ec:	6308                	ld	a0,0(a4)
 8ee:	40e506b3          	sub	a3,a0,a4
              sizeof(page_t);
  if (avail > size) {
 8f2:	6785                	lui	a5,0x1
 8f4:	37e1                	addiw	a5,a5,-8
 8f6:	9f95                	subw	a5,a5,a3
 8f8:	02f4f563          	bgeu	s1,a5,922 <l_alloc+0x54>
    res = alloc.next_page->cur;
    alloc.next_page->cur += size;
 8fc:	1482                	slli	s1,s1,0x20
 8fe:	9081                	srli	s1,s1,0x20
 900:	94aa                	add	s1,s1,a0
 902:	e304                	sd	s1,0(a4)
  } else {
    return 0;
  }
 ...
 912:	f98080e7          	jalr	-104(ra) # 8a6 <mem_init>
    if_init = 1;
 916:	4785                	li	a5,1
 918:	00000717          	auipc	a4,0x0
 91c:	08f72423          	sw	a5,136(a4) # 9a0 <if_init>
 920:	b7d1                	j	8e4 <l_alloc+0x16>
    return 0;
 922:	4501                	li	a0,0
 924:	b7c5                	j	904 <l_alloc+0x36>

0000000000000926 <l_free>:
