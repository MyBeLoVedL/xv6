...
main(int argc, char *argv[])
{
  ...
  2e:	86ea0a13          	addi	s4,s4,-1938 # 898 <l_free+0xc>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	83858593          	addi	a1,a1,-1992 # 8a0 <l_free+0x14>
  70:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a6:	40eb8b93          	addi	s7,s7,1038 # 8b0 <digits>
 ...
 5e6:	2c690913          	addi	s2,s2,710 # 8a8 <l_free+0x1c>
        while(*s != 0){
...
void free(void *ap) {
 ...
 6ae:	22e7b783          	ld	a5,558(a5) # 8d8 <freep>
...
void free(void *ap) {
 ...
 71e:	1af73f23          	sd	a5,446(a4) # 8d8 <freep>
}
 722:	6422                	ld	s0,8(sp)
...
void *malloc(uint nbytes) {
 ...
 778:	16490913          	addi	s2,s2,356 # 8d8 <freep>
  if (p == (char *)-1)
 77c:	5afd                	li	s5,-1
 77e:	a88d                	j	7f0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 780:	00000797          	auipc	a5,0x0
 784:	16078793          	addi	a5,a5,352 # 8e0 <base>
 788:	00000717          	auipc	a4,0x0
 78c:	14f73823          	sd	a5,336(a4) # 8d8 <freep>
 790:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b2:	12a73523          	sd	a0,298(a4) # 8d8 <freep>
      return (void *)(p + 1);
...
void mem_init() {
 ...
 822:	0aa7b923          	sd	a0,178(a5) # 8d0 <alloc>
  page_t *p = (page_t *)alloc.next_page;
  p->cur = (void *)p + sizeof(page_t);
 826:	00850793          	addi	a5,a0,8 # 1008 <__BSS_END__+0x718>
 82a:	e11c                	sd	a5,0(a0)
}
 82c:	60a2                	ld	ra,8(sp)
 82e:	6402                	ld	s0,0(sp)
...
void *l_alloc(u32 size) {
 ...
 844:	0887a783          	lw	a5,136(a5) # 8c8 <if_init>
 848:	c795                	beqz	a5,874 <l_alloc+0x40>
    mem_init();
    if_init = 1;
  }
  void *res = 0;
 ...
 84e:	08673703          	ld	a4,134(a4) # 8d0 <alloc>
 852:	6308                	ld	a0,0(a4)
 854:	40e506b3          	sub	a3,a0,a4
              sizeof(page_t);
  if (avail > size) {
 858:	6785                	lui	a5,0x1
 85a:	37e1                	addiw	a5,a5,-8
 85c:	9f95                	subw	a5,a5,a3
 85e:	02f4f563          	bgeu	s1,a5,888 <l_alloc+0x54>
    res = alloc.next_page->cur;
    alloc.next_page->cur += size;
 862:	1482                	slli	s1,s1,0x20
 864:	9081                	srli	s1,s1,0x20
 866:	94aa                	add	s1,s1,a0
 868:	e304                	sd	s1,0(a4)
  } else {
    return 0;
  }
 ...
 878:	f98080e7          	jalr	-104(ra) # 80c <mem_init>
    if_init = 1;
 87c:	4785                	li	a5,1
 87e:	00000717          	auipc	a4,0x0
 882:	04f72523          	sw	a5,74(a4) # 8c8 <if_init>
 886:	b7d1                	j	84a <l_alloc+0x16>
    return 0;
 888:	4501                	li	a0,0
 88a:	b7c5                	j	86a <l_alloc+0x36>

000000000000088c <l_free>:
