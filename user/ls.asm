...
ls(char *path)
{
 ...
 128:	9f450513          	addi	a0,a0,-1548 # b18 <l_free+0x3c>
 ...
 166:	98658593          	addi	a1,a1,-1658 # ae8 <l_free+0xc>
 16a:	4509                	li	a0,2
 ...
 17c:	98858593          	addi	a1,a1,-1656 # b00 <l_free+0x24>
 180:	4509                	li	a0,2
 ...
 1ae:	97e50513          	addi	a0,a0,-1666 # b28 <l_free+0x4c>
 ...
 1f4:	950a0a13          	addi	s4,s4,-1712 # b40 <l_free+0x64>
        printf("ls: cannot stat %s\n", buf);
 1f8:	00001a97          	auipc	s5,0x1
 1fc:	908a8a93          	addi	s5,s5,-1784 # b00 <l_free+0x24>
...
main(int argc, char *argv[])
{
 ...
 2be:	89650513          	addi	a0,a0,-1898 # b50 <l_free+0x74>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 62a:	53a50513          	addi	a0,a0,1338 # b60 <digits>
 62e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f6:	46eb8b93          	addi	s7,s7,1134 # b60 <digits>
 ...
 836:	32690913          	addi	s2,s2,806 # b58 <l_free+0x7c>
        while(*s != 0){
...
void free(void *ap) {
 ...
 8fe:	28e7b783          	ld	a5,654(a5) # b88 <freep>
...
void free(void *ap) {
 ...
 96e:	20f73f23          	sd	a5,542(a4) # b88 <freep>
}
 972:	6422                	ld	s0,8(sp)
...
void *malloc(uint nbytes) {
 ...
 9a0:	1ec53503          	ld	a0,492(a0) # b88 <freep>
 ...
 9c8:	1c490913          	addi	s2,s2,452 # b88 <freep>
  if (p == (char *)-1)
 9cc:	5afd                	li	s5,-1
 9ce:	a88d                	j	a40 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9d0:	00000797          	auipc	a5,0x0
 9d4:	1d078793          	addi	a5,a5,464 # ba0 <base>
 9d8:	00000717          	auipc	a4,0x0
 9dc:	1af73823          	sd	a5,432(a4) # b88 <freep>
 9e0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a02:	18a73523          	sd	a0,394(a4) # b88 <freep>
      return (void *)(p + 1);
...
void mem_init() {
 ...
 a72:	10a7b923          	sd	a0,274(a5) # b80 <alloc>
  page_t *p = (page_t *)alloc.next_page;
  p->cur = (void *)p + sizeof(page_t);
 a76:	00850793          	addi	a5,a0,8 # 1008 <__BSS_END__+0x458>
 a7a:	e11c                	sd	a5,0(a0)
}
 a7c:	60a2                	ld	ra,8(sp)
 a7e:	6402                	ld	s0,0(sp)
...
void *l_alloc(u32 size) {
 ...
 a94:	0e87a783          	lw	a5,232(a5) # b78 <if_init>
 a98:	c795                	beqz	a5,ac4 <l_alloc+0x40>
    mem_init();
    if_init = 1;
  }
  void *res = 0;
 ...
 a9e:	0e673703          	ld	a4,230(a4) # b80 <alloc>
 aa2:	6308                	ld	a0,0(a4)
 aa4:	40e506b3          	sub	a3,a0,a4
              sizeof(page_t);
  if (avail > size) {
 aa8:	6785                	lui	a5,0x1
 aaa:	37e1                	addiw	a5,a5,-8
 aac:	9f95                	subw	a5,a5,a3
 aae:	02f4f563          	bgeu	s1,a5,ad8 <l_alloc+0x54>
    res = alloc.next_page->cur;
    alloc.next_page->cur += size;
 ab2:	1482                	slli	s1,s1,0x20
 ...
 ac8:	f98080e7          	jalr	-104(ra) # a5c <mem_init>
    if_init = 1;
 acc:	4785                	li	a5,1
 ace:	00000717          	auipc	a4,0x0
 ad2:	0af72523          	sw	a5,170(a4) # b78 <if_init>
 ad6:	b7d1                	j	a9a <l_alloc+0x16>
    return 0;
 ad8:	4501                	li	a0,0
 ada:	b7c5                	j	aba <l_alloc+0x36>

0000000000000adc <l_free>:
