...
main(int argc, char *argv[])
{
  ...
  14:	86858593          	addi	a1,a1,-1944 # 878 <l_free+0x10>
  18:	4509                	li	a0,2
  ...
  50:	84458593          	addi	a1,a1,-1980 # 890 <l_free+0x28>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b6:	4fe50513          	addi	a0,a0,1278 # 8b0 <digits>
 3ba:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 482:	432b8b93          	addi	s7,s7,1074 # 8b0 <digits>
 ...
 5c2:	2ea90913          	addi	s2,s2,746 # 8a8 <l_free+0x40>
        while(*s != 0){
...
void free(void *ap) {
 ...
 68a:	2527b783          	ld	a5,594(a5) # 8d8 <freep>
...
void free(void *ap) {
 ...
 6fa:	1ef73123          	sd	a5,482(a4) # 8d8 <freep>
}
 6fe:	6422                	ld	s0,8(sp)
...
void *malloc(uint nbytes) {
 ...
 72c:	1b053503          	ld	a0,432(a0) # 8d8 <freep>
 ...
 754:	18890913          	addi	s2,s2,392 # 8d8 <freep>
  if (p == (char *)-1)
 758:	5afd                	li	s5,-1
 75a:	a88d                	j	7cc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 75c:	00000797          	auipc	a5,0x0
 760:	18478793          	addi	a5,a5,388 # 8e0 <base>
 764:	00000717          	auipc	a4,0x0
 768:	16f73a23          	sd	a5,372(a4) # 8d8 <freep>
 76c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78e:	14a73723          	sd	a0,334(a4) # 8d8 <freep>
      return (void *)(p + 1);
...
void mem_init() {
 ...
 7fe:	0ca7bb23          	sd	a0,214(a5) # 8d0 <alloc>
  page_t *p = (page_t *)alloc.next_page;
  p->cur = (void *)p + sizeof(page_t);
 802:	00850793          	addi	a5,a0,8 # 1008 <__BSS_END__+0x718>
 806:	e11c                	sd	a5,0(a0)
}
 808:	60a2                	ld	ra,8(sp)
 80a:	6402                	ld	s0,0(sp)
...
void *l_alloc(u32 size) {
 ...
 820:	0ac7a783          	lw	a5,172(a5) # 8c8 <if_init>
 824:	c795                	beqz	a5,850 <l_alloc+0x40>
    mem_init();
    if_init = 1;
  }
  void *res = 0;
 ...
 82a:	0aa73703          	ld	a4,170(a4) # 8d0 <alloc>
 82e:	6308                	ld	a0,0(a4)
 830:	40e506b3          	sub	a3,a0,a4
              sizeof(page_t);
  if (avail > size) {
 834:	6785                	lui	a5,0x1
 836:	37e1                	addiw	a5,a5,-8
 838:	9f95                	subw	a5,a5,a3
 83a:	02f4f563          	bgeu	s1,a5,864 <l_alloc+0x54>
    res = alloc.next_page->cur;
    alloc.next_page->cur += size;
 83e:	1482                	slli	s1,s1,0x20
 840:	9081                	srli	s1,s1,0x20
 842:	94aa                	add	s1,s1,a0
 844:	e304                	sd	s1,0(a4)
  } else {
    return 0;
  }
 ...
 854:	f98080e7          	jalr	-104(ra) # 7e8 <mem_init>
    if_init = 1;
 858:	4785                	li	a5,1
 85a:	00000717          	auipc	a4,0x0
 85e:	06f72723          	sw	a5,110(a4) # 8c8 <if_init>
 862:	b7d1                	j	826 <l_alloc+0x16>
    return 0;
 864:	4501                	li	a0,0
 866:	b7c5                	j	846 <l_alloc+0x36>

0000000000000868 <l_free>:
