...
main(int argc, char *argv[])
{
  ...
  14:	b2058593          	addi	a1,a1,-1248 # b30 <strstr+0x5e>
  18:	4509                	li	a0,2
  ...
  50:	afc58593          	addi	a1,a1,-1284 # b48 <strstr+0x76>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ce:	79e50513          	addi	a0,a0,1950 # b68 <digits>
 3d2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49a:	6d2b8b93          	addi	s7,s7,1746 # b68 <digits>
 ...
 5da:	58a90913          	addi	s2,s2,1418 # b60 <strstr+0x8e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a2:	5827b783          	ld	a5,1410(a5) # c20 <freep>
 ...
 6d0:	00e6ea63          	bltu	a3,a4,6e4 <free+0x50>
{
 ...
 712:	50f73923          	sd	a5,1298(a4) # c20 <freep>
}
 716:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 744:	4e053503          	ld	a0,1248(a0) # c20 <freep>
 ...
 76c:	4b890913          	addi	s2,s2,1208 # c20 <freep>
  if(p == (char*)-1)
 770:	5afd                	li	s5,-1
 772:	a88d                	j	7e4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 774:	00000797          	auipc	a5,0x0
 778:	4b478793          	addi	a5,a5,1204 # c28 <base>
 77c:	00000717          	auipc	a4,0x0
 780:	4af73223          	sd	a5,1188(a4) # c20 <freep>
 784:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a6:	46a73f23          	sd	a0,1150(a4) # c20 <freep>
      return (void*)(p + 1);
...
int Pipe(int *p) {
 ...
 80e:	ad4080e7          	jalr	-1324(ra) # 2de <pipe>
 812:	84aa                	mv	s1,a0
  if (res < 0) {
 ...
 828:	35c58593          	addi	a1,a1,860 # b80 <digits+0x18>
 82c:	4509                	li	a0,2
...
int Write(int fd, void *buf, int count){
 ...
 844:	aae080e7          	jalr	-1362(ra) # 2ee <write>
  if (res < 0) {
 ...
 858:	34458593          	addi	a1,a1,836 # b98 <digits+0x30>
 85c:	4509                	li	a0,2
 ...
 86c:	a66080e7          	jalr	-1434(ra) # 2ce <exit>
...
int Read(int fd,  void*buf, int count){
 ...
 87c:	a6e080e7          	jalr	-1426(ra) # 2e6 <read>
  if (res < 0) {
 ...
 890:	31c58593          	addi	a1,a1,796 # ba8 <digits+0x40>
 894:	4509                	li	a0,2
 ...
 8a4:	a2e080e7          	jalr	-1490(ra) # 2ce <exit>
...
int Open(const char* path, int flag){
 ...
 8b4:	a5e080e7          	jalr	-1442(ra) # 30e <open>
  if (res < 0) {
 ...
 8c8:	2f458593          	addi	a1,a1,756 # bb8 <digits+0x50>
 8cc:	4509                	li	a0,2
 ...
 8dc:	9f6080e7          	jalr	-1546(ra) # 2ce <exit>
...
int Fstat(int fd, stat_t *st){
 ...
 8ec:	a3e080e7          	jalr	-1474(ra) # 326 <fstat>
  if (res < 0) {
 ...
 900:	2cc58593          	addi	a1,a1,716 # bc8 <digits+0x60>
 904:	4509                	li	a0,2
 ...
 914:	9be080e7          	jalr	-1602(ra) # 2ce <exit>
...
int Dup(int fd){
 ...
 924:	a26080e7          	jalr	-1498(ra) # 346 <dup>
  if (res < 0) {
 ...
 938:	2ac58593          	addi	a1,a1,684 # be0 <digits+0x78>
 93c:	4509                	li	a0,2
 ...
 94c:	986080e7          	jalr	-1658(ra) # 2ce <exit>
...
int Close(int fd){
 ...
 95c:	99e080e7          	jalr	-1634(ra) # 2f6 <close>
  if (res < 0) {
 ...
 970:	28458593          	addi	a1,a1,644 # bf0 <digits+0x88>
 974:	4509                	li	a0,2
 ...
 984:	94e080e7          	jalr	-1714(ra) # 2ce <exit>
...
int Dup2(int old_fd,int new_fd){
 ...
 9ba:	22a58593          	addi	a1,a1,554 # be0 <digits+0x78>
 9be:	4509                	li	a0,2
 ...
 9ce:	904080e7          	jalr	-1788(ra) # 2ce <exit>
...
int Stat(const char*link,stat_t *st){
 ...
 9e2:	7ae080e7          	jalr	1966(ra) # 18c <stat>
  if (res < 0) {
 ...
 9fa:	21258593          	addi	a1,a1,530 # c08 <digits+0xa0>
 9fe:	4509                	li	a0,2
 ...
 a0e:	8c4080e7          	jalr	-1852(ra) # 2ce <exit>
...
int strncmp(const char*s, const char*pat,int n){
 ...
 a40:	66c080e7          	jalr	1644(ra) # a8 <strlen>
 ...
 a56:	656080e7          	jalr	1622(ra) # a8 <strlen>
 ...
 ac8:	5e4080e7          	jalr	1508(ra) # a8 <strlen>
...
int strstr(char *s,char *p){
 ...
 af2:	5ba080e7          	jalr	1466(ra) # a8 <strlen>
